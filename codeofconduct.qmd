...
This Code of Conduct is adapted from the [ManyManys’ Code of Conduct](https://manymanys.github.io/COC/), which in turn has been adapted from the [ManyBabies Code of Conduct](https://manybabies.org/codeofconduct/), the [Contributor Covenant, version 1.4](https://www.contributor-covenant.org/version/1/4/code-of-conduct.html), and the [Psych-DS Code of Conduct](https://github.com/psych-ds/psych-DS/blob/master/CODE_OF_CONDUCT.md).

## Contribute

Note that this is a living document. Comments and questions are explicitly encouraged. Feel free to [contact the leadership team](mailto:manydogsproject@gmail.com) or [submit a GitHub issue](https://github.com/ManyDogsProject/manydogsproject.github.io/issues).
